...
//Returns the animal you have discovered.
	string getAnim() {
		return Discovery;
	}
};
	...
	void Events(){
		...
		if (choice1 == "Right") {
			...
			if (MinorChoice1 == "Left") {
				...
				score++;
				cout << "You head towards the cave and notice a small hand-made shack next to the entrace of the cave, it seems beaten and scratched" << endl;
