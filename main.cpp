...
//Displaying output for possible terrain choices
	...
	cout << endl;
	cout << "Be aware, that if you put in an invalid input, it will stop the story where you are at, and will score you accordingly!" << endl;
	cout << endl;
	...
	cout << "You have "<< terra -> get_events() << " possible events to go through!" << endl;
